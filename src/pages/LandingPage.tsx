            ...
            <div className="relative flex justify-center">
              <div className="relative max-w-sm mx-auto">
                <div className="relative">
                  ...
                  <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-blue-600/90 backdrop-blur-sm px-4 py-2 rounded-full shadow-lg border-2 border-white pointer-events-none">
